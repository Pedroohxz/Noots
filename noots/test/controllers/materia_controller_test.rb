...
class MateriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create materium" do
    assert_difference('Materium.count') do
      post materia_url, params: { materium: { materia: @materium.materia, nota_bimestral: @materium.nota_bimestral, nota_mensal: @materium.nota_mensal } }
    end
  ...
  test "should update materium" do
    patch materium_url(@materium), params: { materium: { materia: @materium.materia, nota_bimestral: @materium.nota_bimestral, nota_mensal: @materium.nota_mensal } }
